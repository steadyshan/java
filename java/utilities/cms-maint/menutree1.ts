...
export const MenuTree: MenuItem[] = [
    ...
    { tab:"Shree Ganesh", label:  '- Q1 2023 onward', child: true, uniqueKey: '', parentKey: 'Shree Ganesh', key: 'shree-ganesh-gte-q1-2023', roles: ['relgion', 'all'], dateUploaded: '06/05/2023' },
